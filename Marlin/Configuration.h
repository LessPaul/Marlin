...
#define CUSTOM_MACHINE_NAME "Sgt Yorkie" //PRH
...
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75 // CR10s
...
#define TEMP_SENSOR_BED 1  // CR10s
...
#define HEATER_0_MAXTEMP 300  //E3D V6
...
#define Z_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.  PRH
#define X_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // set to true to invert the logic of the probe.  PRH
 ...
 */
#define DEFAULT_ACCELERATION          500	    // X, Y, Z and E acceleration for printing moves     CR10s
#define DEFAULT_RETRACT_ACCELERATION  500    // E acceleration for retracts                        CR10s
#define DEFAULT_TRAVEL_ACCELERATION   1000    // X, Y, Z acceleration for travel (non printing) moves  CR10s
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 48  // X offset: -left  +right  [of the nozzle]  PRH
#define Y_PROBE_OFFSET_FROM_EXTRUDER -2  // Y offset: -front +behind [the nozzle]     PRH
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2  // Z offset: -below +above  [the nozzle]     PRH

// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE 14
...
#define Z_MIN_PROBE_REPEATABILITY_TEST    // PRH TEMP
...
#define INVERT_Y_DIR false // CR10s
#define INVERT_Z_DIR true // CR10s
...
#define X_BED_SIZE 300 // CR10s
#define Y_BED_SIZE 300 // CR10s
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 7     // Don't use more than 15 points per axis, implementation limited. PRH
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
//
#define EEPROM_SETTINGS // Enable for M500 and M501 commands   // PRH
...
#define NOZZLE_PARK_FEATURE  // CR10s	
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER  //CR10s
